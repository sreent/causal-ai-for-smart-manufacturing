"""Build labs/ch11/lab11b_te_ope.ipynb — off-policy evaluation on the Tennessee Eastman simulator."""
import sys, pathlib
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sreent/causal-ai-for-smart-manufacturing/blob/main/labs/ch11/lab11b_te_ope.ipynb)
...
write_notebook(pathlib.Path(__file__).parent.parent / "ch11" / "lab11b_te_ope.ipynb", cells)
print("Built lab11b_te_ope.ipynb")
