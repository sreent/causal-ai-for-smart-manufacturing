"""Build labs/ch05/lab05b_secom_dml.ipynb — DML on SECOM with four-estimator comparison."""
import sys, pathlib
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sreent/causal-ai-for-smart-manufacturing/blob/main/labs/ch05/lab05b_secom_dml.ipynb)
...
write_notebook(pathlib.Path(__file__).parent.parent / "ch05" / "lab05b_secom_dml.ipynb", cells)
print("Built lab05b_secom_dml.ipynb")
