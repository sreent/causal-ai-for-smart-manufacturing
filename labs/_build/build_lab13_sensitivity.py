"""Build labs/ch13/lab13_sensitivity.ipynb — Transportability, sensitivity, and deployment."""
import sys, pathlib
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sreent/causal-ai-for-smart-manufacturing/blob/main/labs/ch13/lab13_sensitivity.ipynb)
...
write_notebook(pathlib.Path(__file__).parent.parent / "ch13" / "lab13_sensitivity.ipynb", cells)
print("Built lab13_sensitivity.ipynb")
