"""Build labs/ch01/lab01_high_auc_trap.ipynb — Correlation to Causation."""
import sys, pathlib
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sreent/causal-ai-for-smart-manufacturing/blob/main/labs/ch01/lab01_high_auc_trap.ipynb)
...
write_notebook(pathlib.Path(__file__).parent.parent / "ch01" / "lab01_high_auc_trap.ipynb", cells)
print("Built lab01_high_auc_trap.ipynb")
