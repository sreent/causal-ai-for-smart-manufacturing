"""Build labs/ch10/lab10_mediation.ipynb — Multi-stage mediation, RCA, and FDC."""
import sys, pathlib
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sreent/causal-ai-for-smart-manufacturing/blob/main/labs/ch10/lab10_mediation.ipynb)
...
write_notebook(pathlib.Path(__file__).parent.parent / "ch10" / "lab10_mediation.ipynb", cells)
print("Built lab10_mediation.ipynb")
