"""Build labs/ch08/lab08_dtr.ipynb — Dynamic regimes, Q-learning, A-learning."""
import sys, pathlib
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sreent/causal-ai-for-smart-manufacturing/blob/main/labs/ch08/lab08_dtr.ipynb)
...
write_notebook(pathlib.Path(__file__).parent.parent / "ch08" / "lab08_dtr.ipynb", cells)
print("Built lab08_dtr.ipynb")
