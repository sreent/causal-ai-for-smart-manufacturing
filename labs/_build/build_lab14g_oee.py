...
*Hint.* Reuse Lab 10B's γ-sweep pattern: attribute a fraction α = 1 - exp(-γ) of the A-on-OEE association to a hypothetical unmeasured confounder; recompute NIE_A.
