"""Build labs/ch11/lab11_ope.ipynb — Off-policy evaluation."""
import sys, pathlib
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sreent/causal-ai-for-smart-manufacturing/blob/main/labs/ch11/lab11_ope.ipynb)
...
write_notebook(pathlib.Path(__file__).parent.parent / "ch11" / "lab11_ope.ipynb", cells)
print("Built lab11_ope.ipynb")
