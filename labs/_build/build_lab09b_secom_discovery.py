"""Build labs/ch09/lab09b_secom_discovery.ipynb — causal discovery on a 15-sensor SECOM slice."""
import sys, pathlib
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sreent/causal-ai-for-smart-manufacturing/blob/main/labs/ch09/lab09b_secom_discovery.ipynb)
...
write_notebook(pathlib.Path(__file__).parent.parent / "ch09" / "lab09b_secom_discovery.ipynb", cells)
print("Built lab09b_secom_discovery.ipynb")
