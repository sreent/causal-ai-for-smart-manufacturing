...
reveal("""If the naive estimate is negative (high speed *correlates with fewer* failures) but the AIPW estimate is positive (high speed *causes more* failures after adjusting for tool_wear), then *operators were slowing worn tools* and that compensation was hiding the direct speed effect. This is the canonical AI4I pattern. The adjusted positive estimate is the deployment-relevant number; the naive negative would lead to the *opposite* (wrong) policy."""),
