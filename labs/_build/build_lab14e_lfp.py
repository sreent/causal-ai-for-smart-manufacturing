...
*Hint.* Reuse Lab 7B's Part 7 code structure. Bin 1 = cycles 2-25; Bin 2 = cycles 26-50.
...
*Hint.* The ICE has two regressions: $L_2 \\sim A_1 + L_1$ (next-confounder model) and $Y \\sim A_1 + L_1 + A_2 + L_2$ (terminal outcome). For one-shot, just regress $Y$ on cumulative n_high.
