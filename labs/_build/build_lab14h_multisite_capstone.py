"""Build labs/ch14/lab14h_multisite_capstone.ipynb — guided capstone Starter F on multi-site synthetic data."""
import sys, pathlib
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sreent/causal-ai-for-smart-manufacturing/blob/main/labs/ch14/lab14h_multisite_capstone.ipynb)
...
write_notebook(pathlib.Path(__file__).parent.parent / "ch14" / "lab14h_multisite_capstone.ipynb", cells)
print("Built lab14h_multisite_capstone.ipynb")
