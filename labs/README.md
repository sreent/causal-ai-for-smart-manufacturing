...
| **LFP batteries** | Real measurements | 4B, 6B, 7B (planned) | Severson et al. 2019 / `data.matr.io/1/` (124 Li-ion cells, 72 fast-charge protocols, RUL = cycles-to-EOL) |
...
│   ├── lfp_prep.py            # (planned) load_lfp for Labs 4B/6B/7B
